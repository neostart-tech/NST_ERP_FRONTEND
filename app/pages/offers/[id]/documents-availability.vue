	...
	<div class="bg-white rounded-lg shadow overflow-hidden">
		...
		<div class="px-6 py-4 border-b border-gray-200 bg-white sticky top-0 z-10">
			<div class="flex items-center justify-between">
				...
				<button
					@click="navigateTo(AppUrl.OFFERS_QUICK_STAT)"
					...
					<div class="flex items-center justify-between">
						<div>
							...
							<p class="text-sm text-gray-600 mt-1">
								Vérifiez le statut de chaque document requis pour votre
								soumission
							</p>
						</div>
						<button
...
const documentsAvailability = ref<Document[]>([
	...
	},
	{
		...
		description:
			"Carte d'immatriculation fiscale servant à identifier l'entreprise",
		required: true,
		status: "available",
		isAvailable: true,
		isValid: true,
	...
	},
	{
		...
		description:
			"Attestation stipulant que vous êtes en règle avec ladministration fiscale",
		required: true,
		status: "missing",
		isAvailable: false,
		isValid: null,
