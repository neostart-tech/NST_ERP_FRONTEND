                        ...
                        <div class="space-y-2">
                          <div v-if="document.uploadedFile" class="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-md">
                            <div class="flex items-center space-x-3">
                              ...
                              <span class="text-sm font-medium text-green-800">{{ document.uploadedFile.name }}</span>
                            </div>
                            <button
...
// Documents availability status
const documentsAvailability = ref([
  {
...
const updateDocumentStatus = (index: number, status: string) => {
  documentsAvailability.value[index].status = status;
};
...
const handleFileUpload = (event: Event, index: number) => {
  ...
  if (file) {
    ...
    documentsAvailability.value[index].uploadedFile = file;
  }
};

const removeUploadedFile = (index: number) => {
  documentsAvailability.value[index].uploadedFile = null;
};
