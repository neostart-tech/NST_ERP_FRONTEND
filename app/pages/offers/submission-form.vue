        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-if="activeTab === 'information'" class="space-y-6">
            <div>
              ...
              ></textarea>
              <p class="mt-1 text-xs text-gray-500">
                Détaillez votre approche technique, méthodologie, technologies
                utilisées...
              </p>
            </div>
              ...
              <div class="space-y-3">
                ...
                >
                  <input
                    ...
                    type="text"
                    class="flex-1 rounded-md px-3 py-2 border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
