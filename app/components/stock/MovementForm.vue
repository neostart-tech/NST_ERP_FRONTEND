	...
	<form @submit.prevent="submitMovementForm">
		...
		<div class="px-6 py-6 grid grid-cols-1 gap-y-6 md:grid-cols-3">
			...
			<div class="md:col-span-3 space-y-6">
				...
				<!-- Produit -->
				<div class="space-y-2">
					<label class="block text-sm font-medium text-gray-700">Produit <RequiredField /></label>
					<select v-model="currentMovement.product_id" name="product_id" required
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div class="space-y-2">
						<label class="block text-sm font-medium text-gray-700">Type de Mouvement <RequiredField /></label>
					...
					<div class="space-y-2">
						<label class="block text-sm font-medium text-gray-700">Quantité <RequiredField /></label>
