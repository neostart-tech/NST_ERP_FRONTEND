<template>
	...
	>
		<div class="flex items-center space-x-4">
			...
			<div class="flex items-center space-x-4">
				<div
					class="hidden lg:block bg-gradient-to-br from-blue-500 to-emerald-500 p-3 rounded-2xl shadow-lg"
				>
					<div
						class="w-5 h-5 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm"
					>
				...
				<div>
					...
					<h2
						class="text-2xl font-bold bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent"
					>
						{{ pageTitle.title }}
					</h2>
...
const pageTitle = computed(() => {
	...
	> = {
		...
		"offers-offer-quick-stat": {
			icon: "heroicons:document-text",
			title: "Statistiques des appels d'offre",
			description: "Statistiques des appels d'offre",
		},
		"sales-clients": {
